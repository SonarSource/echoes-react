...
const TAILWIND_CONFIG_FILENAME = 'tailwindConfig.ts';

const licenseHeader = fs.readFileSync(`config/license/LICENSE-HEADER.txt`, 'utf-8');
const tailwindTypographyPlugin = JSON.parse(
...
function initStyleDictionary(licenseHeader) {
  ...
  StyleDictionary.registerFilter({
    ...
    matcher: ({ attributes }) => attributes.type !== 'color',
  });
...
// Build tailwind config to be used as a preset
