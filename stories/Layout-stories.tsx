...
export const WithAsideRight: Story = {
  args: {},
  render(args) {
    return (
      <VisibleLayout {...args}>
        <Layout.Main>
          <VisibleBlock>
            ...
            with a lot of content that should wrap at some pointMAIN with a lot of content that
            should wrap at some pointMAIN with a lot of content that should wrap at some pointMAIN
            with a lot of content that should wrap at some pointMAIN with a lot of content that
            should wrap at some pointMAIN with a lot of content that should wrap at some pointMAIN
            with a lot of content that should wrap at some pointMAIN with a lot of content that
            should wrap at some pointMAIN with a lot of content that should wrap at some point
          </VisibleBlock>
        </Layout.Main>
        <Layout.AsideRight>
          <VisibleBlock>RIGHT</VisibleBlock>
        </Layout.AsideRight>
      </VisibleLayout>
    );
  },
...
export const WithAsideLeft: Story = {
  args: {},
  render(args) {
    return (
      <VisibleLayout {...args}>
        <Layout.AsideLeft>
          <VisibleBlock>LEFT</VisibleBlock>
        </Layout.AsideLeft>
        <Layout.Main>
          <VisibleBlock>
            MAIN with a lot of content that should wrap at some pointMAIN with a lot of content that
...
export const WithBothAsides: Story = {
  args: {},
  render(args) {
    return (
      <VisibleLayout {...args}>
