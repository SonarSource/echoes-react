...
export const FooterNavlist = forwardRef<HTMLUListElement, Readonly<FooterNavlistProps>>(
  (props, ref) => {
    const { children, ...rest } = props;

    return (
      <StyledFooterNavlist ref={ref} {...rest}>
        {children}
      </StyledFooterNavlist>
    );
  },
...
`;
StyledFooterNavlist.displayName = 'StyledFooterNavlist';
