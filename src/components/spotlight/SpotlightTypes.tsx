...
import { SpotlightModalProps } from './SpotlightModal';
...
export interface SpotlightProps {
  ...
  /**
   * Should we display the tour progress in the Next button in continuous tours?
   * Defaults to false (optional)
   */
  shouldShowProgressInNextButton?: boolean;
