 ...
 *  exceeded" error.
 *
 *  For instace, using ReactJoyride directly instead of through this component:
 *
...
export function Spotlight(props: Readonly<SpotlightProps>) {
  const {
    ...
    shouldShowProgressInNextButton = false,
    skipLabel,
    stepIndex,
    steps,
    stepXofYLabel,
  ...
  return (
    <ReactJoyride
      ...
      run={isRunning}
      showProgress={shouldShowProgressInNextButton}
      stepIndex={stepIndex}
      /*********************************************************************************************
       *   ^
