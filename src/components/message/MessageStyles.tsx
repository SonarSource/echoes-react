...
export const styleMessageContainerCallout = styled(MessageContainer)`
  background-color: var(--message-background);
  padding: var(--echoes-dimension-space-200);
`.withComponent;

export const styleMessageContainerInline = styled(MessageContainer)`
...
export const MessageIconWrapper = styled.div<{ addMargin: boolean }>`
  flex: 0 0 auto;
...
export const styleMessageDismissButton = styled.button`
  flex: 0 0 auto;
