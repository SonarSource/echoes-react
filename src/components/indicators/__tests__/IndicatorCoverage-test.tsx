...
import { IndicatorCoverage } from '../IndicatorCoverage';
import { IndicatorCoverageRating } from '../indicatorUtils';
...
it.each([
  ...
  const { container } = render(
    <IndicatorCoverage data-testid="coverage-indicator" rating={rating} />,
  );
