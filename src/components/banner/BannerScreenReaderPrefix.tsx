    ...
    case BannerType.Info:
      return (
        <FormattedMessage
          ...
          description="Screen reader only text that express the type of the Info banner"
    ...
    case BannerType.Danger:
      return (
        <FormattedMessage
          ...
          description="Screen reader only text that express the type of the Danger banner"
    ...
    case BannerType.Warning:
      return (
        <FormattedMessage
          ...
          description="Screen reader only text that express the type of the Warning banner"
    ...
    case BannerType.Success:
      return (
        <FormattedMessage
          ...
          description="Screen reader only text that express the type of the Success banner"
