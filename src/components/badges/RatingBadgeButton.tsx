...
RatingBadgeButton.displayName = 'RatingBadgeLink';
    ...
    rating === RatingBadgeRating.Null
      ...
      : `
          & div: hover {
            ...
            // rating will never be undefined as we assign a default value
            border: 1px solid var(--echoes-ratings-colors-border-rating-${rating!.toLowerCase()}-hover);
          }
        `}

  ${({ size }) => {
    // size will never be undefined as we assign a default value
