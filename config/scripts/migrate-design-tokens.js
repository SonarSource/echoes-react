 ...
 *   node config/scripts/update-design-tokens.js
 *
...
const TOKEN_MAPPINGS = {
  ...
  '--echoes-color-background-neutral-weak-default':
    '--echoes-color-background-neutral-subtle-default',
  '--echoes-color-background-neutral-weak-hover': '--echoes-color-background-neutral-subtle-hover',
  '--echoes-color-background-neutral-weak-active':
    '--echoes-color-background-neutral-subtle-active',
