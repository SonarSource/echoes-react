...
- **Folder placement**: New components must live in `src/components/{kebab-case-name}/`. Flag components landing directly in `src/components/` without their own folder.
